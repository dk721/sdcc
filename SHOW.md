...
Ц0["Ц0. Безопасное и подотчётное\nиспользование\nкорпоративной ИС"]

Ц0 --> Ц1["Ц1. Обеспечить доступ\nлегитимных пользователей\nк ресурсам"]
Ц0 -------> Ц2["Ц2. Организовать полный,\nдостоверный и защищённый\nучёт действий"]
Ц0 --> Ц3["Ц3. Создать средства\nоперативного\nреагирования и анализа"]

Ц1 --> Ц1_1["Ц1.1 Надёжная\nидентификация субъектов"]
Ц1 ----> Ц1_2["Ц1.2 Исключить\nнесанкционированный\nдоступ"]
Ц1 --> Ц1_3["Ц1.3 Отказоустойчивость\nсервисов доступа"]

Ц1_1 --> Ц1_1_1["Ц1.1.1 Уникальные\nидентификаторы и\nучётные политики"]
Ц1_1 --> Ц1_1_2["Ц1.1.2 Синхронизация с\nкадровой системой"]
Ц1_2 --> Ц1_2_1["Ц1.2.1 Многофакторная\nаутентификация для\nкритичных систем"]
Ц1_2 --> Ц1_2_2["Ц1.2.2 Ролевая\nмодель (RBAC)"]
Ц1_2 --> Ц1_2_3["Ц1.2.3 Принцип\nминимальных привилегий"]
Ц1_3 --> Ц1_3_1["Ц1.3.1 Кластеризация\nсерверов аутентификации"]
Ц1_3 --> Ц1_3_2["Ц1.3.2 Локальные\nполитики\noffline-доступа"]

Ц2 --> Ц2_1["Ц2.1 Регистрация всех\nсобытий без потерь"]
Ц2 ----> Ц2_2["Ц2.2 Защита журналов\nот компрометации"]
Ц2 --> Ц2_3["Ц2.3 Глубокая\nретроспектива событий"]

Ц2_1 --> Ц2_1_1["Ц2.1.1 Агенты аудита\nна всех целевых объектах"]
Ц2_1 --> Ц2_1_2["Ц2.1.2 Стандартизированный\nформат записей (JSON, CEF)"]
Ц2_2 --> Ц2_2_1["Ц2.2.1 Электронная\nподпись записей"]
Ц2_2 --> Ц2_2_2["Ц2.2.2 Однократная\nзапись (WORM)"]
Ц2_3 --> Ц2_3_1["Ц2.3.1 Ротация и\nхолодное архивирование"]
Ц2_3 --> Ц2_3_2["Ц2.3.2 Политики\nхранения согласно\nISO 27001, GDPR"]

Ц3 --> Ц3_1["Ц3.1 Выявление подозрительной\nактивности\nв реальном времени"]
Ц3 ----> Ц3_2["Ц3.2 Информирование\nоб инцидентах"]
Ц3 --> Ц3_3["Ц3.3 Удовлетворение\nзапросов аудиторов\nи регуляторов"]

Ц3_1 --> Ц3_1_1["Ц3.1.1 Библиотека правил\nкорреляции (brute-force,\nвход в нерабочее время)"]
Ц3_1 --> Ц3_1_2["Ц3.1.2 Модель UEBA на\nбазовых паттернах поведения"]
Ц3_2 --> Ц3_2_1["Ц3.2.1 Мгновенные уведомления\n(SIEM-тикеты,\nTelegram, Email)"]
Ц3_2 --> Ц3_2_2["Ц3.2.2 Дашборды состояния\nв реальном времени"]
Ц3_3 --> Ц3_3_1["Ц3.3.1 Конструктор отчётов\nпо шаблонам"]
Ц3_3 --> Ц3_3_2["Ц3.3.2 Автоматическая выгрузка\nдля Compliance-проверок"]
...
PEP -->|2. Запрос авторизации| PDP[Точка принятия\nрешений PDP]
...
U[Пользователь] -->|Учётные данные, Запрос доступа| P1[1. Идентификация\nи аутентификация]
P1 -->|Аутентифицированный запрос| P2[2. Авторизация и\nприменение политик]
P2 -->|Разрешение / Отказ| R["Целевая ИС (Ресурс)"]
R -->|События доступа| P3[3. Аудит и\nжурналирование]
P3 -->|Структурированные события| P4[4. Мониторинг и\nоповещение]
